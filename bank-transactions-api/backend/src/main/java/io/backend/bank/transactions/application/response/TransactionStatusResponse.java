...
import io.backend.bank.transactions.application.utils.DateUtils;
...
@Schema(name = "TransactionStatusResponse", description = "Transaction status response information")
public class TransactionStatusResponse {
    ...
    @Schema(description = "Transaction status", example = "SETTLED", type = "TransactionStatus")
